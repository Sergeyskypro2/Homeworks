...
class CompanyTable:
    ...
    __scripts = {
        ...
        "select only active": "select * from company where \"is_active\" = true  and deleted_at is null", # noqa
    ...
    def get_company_by_id(self, id):
        return self.__db.execute(self.__scripts("select by id"), select_id=id).fetchall() # noqa

    def get_active_companies(self):
        return self.__db.execute(self.__scripts("select only active")).fetchall() # noqa
